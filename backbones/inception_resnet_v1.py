...
def inference(images, keep_probability, phase_train=True, 
              bottleneck_layer_size=128, weight_decay=0.0, reuse=tf.AUTO_REUSE):
    batch_norm_params = {
...
def inception_resnet_v1(inputs, is_training=True,
    ...
    with tf.variable_scope(scope, 'InceptionResnetV1', [inputs], reuse=tf.AUTO_REUSE):
